...
class StandardGameTest {
    ...
    void addGetPlayerTest(){
        ...
        try {
            ...
            System.out.println("PLayerAlreadyExists caught");
        }
        ...
        try {
            ...
            System.out.println("MatchmakingClosed caught");
        }

        try{
            test.getPlayer("randomID");
            fail();
        }
        catch(PlayerNotExistsException e){
            System.out.println("PlayerNotExistsException caught");
        }

        try{
            Player playerTest = test.getPlayer("playerID1");
            assertEquals(playerTest.getId(), "playerID1");
        }
        catch(Exception e){
            fail();
        }
