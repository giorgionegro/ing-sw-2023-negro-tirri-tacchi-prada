...
public interface GameManagerController {
     ...
     * has been build during a {@link #createGame(NewGameInfo)} call and has been associated to the given {@link NewGameInfo} gameID
    ...
    /**
     * This method build a {@link GameController} on the given new-game info
